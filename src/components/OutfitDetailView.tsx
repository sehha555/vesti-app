      ...
      >
        ...
        <div className="absolute top-4 right-4 z-10">
          <motion.button
            whileTap={{ scale: 0.9 }}
            onClick={onClose}
            className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--vesti-light-bg)] hover:bg-[var(--vesti-gray-light)] transition-colors"
          >
            ...
            <div className="grid grid-cols-2 gap-3 pb-6">
              {outfit.items.map((item, index) => (
                ...
                >
                  ...
                  <div className="p-3">
                    <p
                      className="text-[var(--vesti-text-secondary)] mb-1"
                      style={{ fontSize: 'var(--text-label)', fontWeight: 400 }}
                    >
                      {item.category}
                    </p>
                    <h4
                      className="text-[var(--vesti-dark)] line-clamp-1 mb-1"
                      style={{ fontSize: 'var(--text-base)' }}
                    >
                      {item.name}
                    </h4>
